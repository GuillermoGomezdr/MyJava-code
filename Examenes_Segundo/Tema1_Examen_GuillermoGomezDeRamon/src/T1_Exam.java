...
public class T1_Exam {
	...
	int[][] precios = {{}, {0, 30, 15}, {0, 20, 12}, {0, 50, 25}, {0, 35, 20}};
	...
	public int calcularPrecio(int precioViaje, int descuento, int numBilletes) {
