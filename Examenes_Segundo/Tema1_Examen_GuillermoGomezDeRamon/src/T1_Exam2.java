...
public class T1_Exam2 {
	...
	double[][] precios = {{}, {0.0, 30.0, 15.0}, {0.0, 20.0, 12.0}, {0.0, 50.0, 25.0}, {0.0, 35.0, 20.0}};
	...
	public double calcularPrecio(double precioViaje, int descuento, int numBilletes) {
