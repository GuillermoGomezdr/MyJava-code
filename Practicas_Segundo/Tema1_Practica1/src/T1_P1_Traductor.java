...
public class T1_P1_Traductor{
	...
	private void initialize() {
		...
		frmTraductorDePalabras.setBounds(100, 100, 235, 262);
		...
		campoATraducir.setBounds(10, 36, 188, 20);
		...
		comboBox.setBounds(10, 94, 188, 20);
