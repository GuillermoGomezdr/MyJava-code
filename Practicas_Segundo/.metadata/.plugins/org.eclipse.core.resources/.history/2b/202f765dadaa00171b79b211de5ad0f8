...
public class T1_P1_Registro {
	...
	/*public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					T1_P1_Registro window = new T1_P1_Registro();
	...
	private void initialize() {
		...
		frmRegistro.setBounds(100, 100, 333, 344);
		...
		textPass.setBounds(132, 36, 185, 20);
		...
		aceptarT.setBounds(6, 251, 311, 23);
		frmRegistro.getContentPane().add(aceptarT);
		
		JButton btnRegistrarse = new JButton("Registrarse");
		btnRegistrarse.setBounds(10, 282, 147, 23);
		...
		btnCancelar.setBounds(170, 281, 147, 23);
		...
		JRadioButton radioButton = new JRadioButton("Entre 18 y 30");
		buttonGroup.add(radioButton);
		radioButton.setBounds(132, 163, 109, 23);
		frmRegistro.getContentPane().add(radioButton);
