...
public class Juego_PruebaSprite{
	...
	public static void main (String[] args) {
		...
		while(true){										// Durante el resto del programa, ejecutaremos un bucle infinito. 
			...
			pjx = Movimiento(movRight, 'x', 100, pjx, pjy);					// Comprobaremos mediante una función si un movimiento se ha puesto a true... 
			pjx = Movimiento(movLeft, 'x', -100, pjx, pjy);					// ... la función ejecutará el movimiento, y devolverá la posición actual ...
